  ...
  return (
    <div className="container max-w-2xl py-12">
      ...
      <section className="mt-6 space-y-3 text-sm leading-relaxed">
        ...
        <p>
          StateSense applies a hand-curated library of UX heuristics to your screens and
      ...
      <ul className="mt-3 space-y-2 text-sm">
        ...
        <li>
          ...
          design contradicts the PRD, journey incomplete). Activates when you add context.
        </li>
      </ul>
      ...
      <ul className="mt-3 space-y-2 text-sm">
        ...
        <li>
          <strong>Recommendation</strong>: a better answer in most cases. &ldquo;Consider X.&rdquo;
        </li>
        <li>
      ...
      <h2 className="mt-10 text-lg font-semibold">Built by</h2>
      <p className="mt-3 text-sm leading-relaxed">
        <strong>Theophilus Fredrick</strong>, a product designer.{" "}
        <a
          href="https://www.linkedin.com/in/theophilus-fredrick/"
          target="_blank"
          rel="noreferrer"
